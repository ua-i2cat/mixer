...
class Layout {
	...
	private:
    	...
    	bool check_introduce_stream_values (int orig_w, int orig_h, enum PixelFormat orig_cp, int new_w, int new_h, enum  PixelFormat new_cp);
	...
	public:
    	...
    	int resize_frame(int stream_id);
    	int update_frame(int stream_id);
    	int merge_frames();
    	int introduce_stream (int orig_w, int orig_h, enum PixelFormat orig_cp, int new_w, int new_h, enum PixelFormat new_cp);
